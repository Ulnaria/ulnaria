...
import 'import_wallet_model.dart';
export 'import_wallet_model.dart';
...
class ImportWalletWidget extends StatefulWidget {
  ...
  static String routePath = '/importwallet';

  @override
  State<ImportWalletWidget> createState() => _ImportWalletWidgetState();
}

class _ImportWalletWidgetState extends State<ImportWalletWidget>
    with TickerProviderStateMixin {
  late ImportWalletModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ImportWalletModel());
                                            ...
                                            child: Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      0.0, 20.0, 0.0, 0.0),
                                              child: Text(
                                                'Enter your email address from Ulnaria  to connect your wallet',
