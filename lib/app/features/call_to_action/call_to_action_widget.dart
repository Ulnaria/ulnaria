...
/// Invite visitor user to signup or login to access this features (only for
/// authenticate users)
    ...
    return Align(
      ...
      child: Padding(
        ...
        child: Container(
          ...
          height: MediaQuery.sizeOf(context).width >= 768.0 ? 310.0 : 360.0,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Register or log in to access all of Ulnaria\'s features and unlock the full potential of our ecosystem.',
