...
import 'f_a_q_non_c_w_model.dart';
export 'f_a_q_non_c_w_model.dart';

/// FAQ: Wallet transaction and all activity used inside the wallet
class FAQNonCWWidget extends StatefulWidget {
  const FAQNonCWWidget({super.key});

  @override
  State<FAQNonCWWidget> createState() => _FAQNonCWWidgetState();
}

class _FAQNonCWWidgetState extends State<FAQNonCWWidget>
    with TickerProviderStateMixin {
  late FAQNonCWModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FAQNonCWModel());
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.asset(
                                'assets/images/kerfin7_nea_2777.jpg',
                                width: double.infinity,
                                height: 100.0,
                                fit: BoxFit.cover,
                              ),
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 15.0, 0.0, 15.0),
                              child: Text(
                                'The first protocol used in the creation of a non-custodial wallet is BIP-39. This protocol allows to obtain a secret phrase at the origin of the public and private keys. First of all, we have an Entropy of (128 bits) which initially gives the SHA-256.',
                                textAlign: TextAlign.justify,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/Capture_dcran_2025-05-24_225359.png',
                                width: double.infinity,
                                height: 100.0,
                                fit: BoxFit.contain,
                              ),
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/Capture_dcran_2025-05-24_225458.png',
                                width: double.infinity,
                                height: 100.0,
                                fit: BoxFit.contain,
                              ),
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/Capture_dcran_2025-05-24_225529.png',
                                width: double.infinity,
                                height: 100.0,
                                fit: BoxFit.contain,
                              ),
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/Capture_dcran_2025-05-24_225544.png',
                                width: double.infinity,
                                height: 100.0,
                                fit: BoxFit.contain,
                              ),
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/Capture_dcran_2025-05-24_225553.png',
                                width: double.infinity,
                                height: 100.0,
                                fit: BoxFit.contain,
                              ),
