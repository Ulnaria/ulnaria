...
import 'schema/price_chart_record.dart';
...
export 'schema/price_chart_record.dart';
...
/// Functions to query PriceChartRecords (as a Stream and as a Future).
Future<int> queryPriceChartRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PriceChartRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PriceChartRecord>> queryPriceChartRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PriceChartRecord.collection,
      PriceChartRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PriceChartRecord>> queryPriceChartRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<int> querySeriesRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      SeriesRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
Future<int> queryWalletRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      WalletRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
