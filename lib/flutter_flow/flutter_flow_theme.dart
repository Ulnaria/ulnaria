...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF9B805);
  late Color secondary = const Color(0xFFF9B805);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0x81F1F4F8);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4DD2B939);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0x81F1F4F8);
  late Color success = const Color(0xFF968324);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color alternate = const Color(0x822D383F);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0xFF2D383F);
  late Color secondaryBackground = const Color(0xFF16202A);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4DD2B139);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0x822D383F);
  late Color success = const Color(0xFF968624);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);
}
